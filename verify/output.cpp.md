...
data:
  ...
  bundledCode: "#line 1 \"verify/output.cpp\"\n#line 1 \"aoj-dsl-1-a.test.cpp\"\n\
    #define PROBLEM \\\n    \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_1_A\"\
    ...
    \ \"/Users/takakurashokichi/Desktop/Github/library/library/template/template.cpp\"\
    ...
    \ &y);\n        if (t == 0)\n            uf.unite(x, y);\n        else\n     \
    \       printf(\"%d\\n\", uf.find(x) == uf.find(y));\n    }\n}\n"
  code: "#line 1 \"aoj-dsl-1-a.test.cpp\"\n#define PROBLEM \\\n    \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_1_A\"\
    \n\n#line 1 \"/Users/takakurashokichi/Desktop/Github/library/library/structure/UnionFind/UnionFind.cpp\"\
    \n\n/**\n * @brief UnionFind\n * @docs docs/union-find.md\n */\nstruct UnionFind\
    \ {\n    vector<int> data;  // sizes of sets\n\n    UnionFind(int sz) : data(sz,\
    \ -1) {}\n\n    bool unite(int x, int y) {\n        x = find(x), y = find(y);\n\
  ...
  path: verify/output.cpp
  requiredBy: []
  timestamp: '2020-11-14 11:43:39+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: verify/output.cpp
layout: document
redirect_from:
- /library/verify/output.cpp
- /library/verify/output.cpp.html
title: UnionFind
---

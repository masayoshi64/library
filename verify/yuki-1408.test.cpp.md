...
data:
  ...
  bundledCode: "#line 1 \"verify/yuki-1408.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/1408\"\
    ...
    \    }\n};\n#line 5 \"verify/yuki-1408.test.cpp\"\nint main() {\n    int n;\n\
    \    cin >> n;\n    vector<string> vs(n);\n    scan(vs);\n    int m;\n    cin\
  ...
  verifiedWith: []
documentation_of: verify/yuki-1408.test.cpp
layout: document
redirect_from:
- /verify/verify/yuki-1408.test.cpp
- /verify/verify/yuki-1408.test.cpp.html
